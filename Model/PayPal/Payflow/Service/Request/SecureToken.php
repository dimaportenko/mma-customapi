 ...
 */
namespace MMA\CustomApi\Model\PayPal\Payflow\Service\Request;;
...
class SecureToken
{
    ...
    public function requestToken(Quote $quote)
    {
        ...
        $request->setReturnurl($this->url->getUrl('mma/transparent/response') . '?quoteId=' . $quote->getId());
        $request->setErrorurl($this->url->getUrl('mma/transparent/response'));
